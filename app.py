...
def main():
    ...
    st.header("Chat with your PDFs and gain more knowledge 📜🪄📖✨ BY ᴹʳ<ᴘʀᴀᴛɪᴋ࿐")
    st.header("Chat with my DOCUBOT💡 | who will help you to skillup your knowledge \n He likes to consume a lot of PDFs and in return he will satisfy your queries 😊")
    user_question = st.text_input("Ask a question about your documents:")
    if user_question:
        handle_userinput(user_question)

    with st.sidebar:
        st.subheader("Drag and drop/Upload your PDFs")
        ...
        if st.button("PROCESS"):
            ...
            with st.spinner("PROCESSING"):
                try:
                    ...
                    st.success("PDF IS POCESSED BY GEMINI ")
                except Exception as e:
